			    ...
			    <section id="distributions-performance">
					...
					<div class="grid-container">
						<div class="grid-x grid-padding-x align-spaced">
							...
							<div id="funds-accordion" class="accordion cell small-12" class="cell small-12">
								...
								<?php if( have_rows('performance') ):?>
									...
									<div id="performance" class="performance-table">
										...
										<div id="performance-frame" style="position:relative; overflow: hidden;">
											<iframe scrolling="no" style="width:100%; border: 0;" src="https://resourcerealestate.alpsinc.com/performance/RCIAX"></iframe>
										</div>
								...
								<?php if( have_rows('distribution_history') ):?>
									...
									<div id="distribution" class="performance-table">
										...
										<div id="distribution-frame" style="height:700px;">
											<iframe src="https://resourcerealestate.alpsinc.com/dividend/RCIAX" style="border:0px; width:100%; height:700px;"></iframe>
										</div>
				    ...
				    <div class="grid-container">
					    <div class="grid-x grid-padding-x">  
						    ...
						    <div class="accordion cell small-12">
							    ...
							    <div>
								    <iframe src="https://resourcerealestate.alpsinc.com/holdings-full/RCIAX" style="width:100%; border:0px; height: 4450px;"></iframe>
							    </div>
						    </div>
